...
export default function FileUpload({ files, setFiles }: FileUploadProps) {
  ...
  const handleFiles = (fileList: FileList) => {
    ...
    setFiles([newFile]); // Replace previous
  ...
  return (
    <div className="w-full">
      ...
      <motion.div
        ...
        className={clsx(
          "relative rounded-2xl p-6 md:p-8 text-center cursor-pointer bg-secondary/50 border border-primary/10 shadow-sm hover:shadow-md backdrop-blur group",
      ...
      >
        <div className="flex flex-col items-center gap-5">
          ...
          >
            ...
            <UploadCloud
              className={clsx(
                "w-10 h-10 md:w-14 md:h-14 drop-shadow-sm",
                isDragging
                  ? "text-blue-500"
